...
function onlyLetters() {
  let input = "I love coding 4 ever";
...
console.log(isThisAnEmail("lisabuffagni@gmail.com"));
...
function isTodayMyBirthday() {
  let today = new Date();
  let birthday = new Date(today.getFullYear(), 3 - 1, 5);
